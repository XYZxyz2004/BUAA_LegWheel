...
class balance_Chassis
{
	...
	private:
		...
		Pid left_leg_len_, right_leg_len_, anti_crash_,w_speed_;
		float left_leg_F_, right_leg_F_, roll_comp;
		float l_wheel_T_, r_wheel_T_, left_leg_T_, right_leg_T_;
		float target_w_speed_, target_speed_, target_dist_, vel_, dist_, acc_,vel_l,vel_r,target_len_;
