...
extern positionpid_t M6020s_PitchIPID;		//Pitch	
extern positionpid_t M6020s_PitchOPID;		//Pitch	
extern positionpid_t AutoAim_M6020s_PitchIPID;
extern positionpid_t AutoAim_M6020s_PitchOPID;
...
extern float Incremental_PID_New(Struct_PID_Manage_Object_Fuzzy *pid_t, float target, float measured);
extern void Incremental_PIDInit_New(Struct_PID_Manage_Object_Fuzzy *pid_t, float Kp, float Ki, float Kd, uint32_t MaxOutput, uint32_t IntegralLimit);
extern void Position_PIDInit_New(Struct_PID_Manage_Object_Fuzzy *pid_t, float Kp, float Kd, float Ki, float MaxOutput, float IntegralLimit, float Integral_Separation);
