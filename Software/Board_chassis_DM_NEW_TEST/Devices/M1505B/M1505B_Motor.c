...
/**
  ...
  */
void M1505B_Enable(void)
{	TPID_Init(&M1505B_Array[0].TPID, 0.12, 0, 0.05, 0.08, 100, 1000, 0);
	TPID_Init(&M1505B_Array[1].TPID, 0.12, 0, 0.05, 0.08, 100, 1000, 0);
	uint8_t getenable=0;
...
void M1505B_setCurrent(void)
{
    M1505B_Data_Tx[0] = M1505B_Array[0].sendCurrent >> 8;
    M1505B_Data_Tx[1] = M1505B_Array[0].sendCurrent;
...
////    data[0] = 0x03;
////    data[1] = 0x21;
   M1505B_Data_Tx[2] = M1505B_Array[1].sendCurrent >> 8;
   M1505B_Data_Tx[3] = M1505B_Array[1].sendCurrent ;
//	    data[0] = 0;
//    data[1] = 0;
//    data[2] = 0;
//    data[3] = 0;
    ...
    M1505B_Data_Tx[6] = 0;
    M1505B_Data_Tx[7] = 0;
	Can_Fun.fdcanx_send_data(&hfdcan1, Send_ID, M1505B_Data_Tx, 8);
}
void M1505B_setSeq(void)
{
	uint8_t data[8];
...
void M1505B_getInfo(FDCan_Export_Data_t RxMessage)
{
    ...
    M1505B_Array[StdId].mode = RxMessage.FDCANx_Export_RxMessage[7];
	  ...
	  M1505B_Array[StdId].realTorqueI=((float) M1505B_Array[StdId].receiveTorqueI)*55/32767*0.8+0.2* M1505B_Array[StdId].realTorqueI;
