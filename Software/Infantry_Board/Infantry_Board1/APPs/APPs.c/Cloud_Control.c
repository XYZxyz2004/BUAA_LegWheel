...
int16_t Cloud_Pitch_level1 = 4280;
const float Cloud_Pitch_Center = 3614;
...
void Cloud_Init(void)
{
    ...
    Cloud.Target_Pitch = Cloud_Pitch_level1;
	  Cloud.Pitch_Raw = Cloud_Pitch_level1 ;
	  Cloud_Init_Angle = Cloud_Pitch_level1;
...
//		}
		...
		Cloud.Target_Pitch = M6020s_Pitch.realAngle + Cloud.AutoAim_Pitch + AutoAim_Cloud_Delta ;//+ ControlMes.Gimbal_Chassis_Pitch_Angle * SEN_Saber_Pitch ;
