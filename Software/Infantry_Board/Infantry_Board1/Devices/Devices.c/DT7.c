...
//	if(GetKeyMouseAction(KEY_R,KeyAction_PRESS)||ControlMes.Blood_Volume == 0) //r
	...
	if(GetKeyMouseAction(KEY_V,KeyAction_PRESS))
	{
		...
		ChassisRamp_Rotate.maxcount = 1150;
		ChassisRamp_Rotate.mincount = -1150;
	}

	if(GetKeyMouseAction(KEY_B,KeyAction_PRESS))
	{
		ChassisRamp_ForwardBack.maxcount = 1000;
		ChassisRamp_ForwardBack.mincount = -1000;
		ChassisRamp_LeftRight.maxcount = 1000;
		ChassisRamp_LeftRight.mincount = -1000;
		ChassisRamp_Rotate.maxcount = 1400;
		ChassisRamp_Rotate.mincount = -1400;
	}
